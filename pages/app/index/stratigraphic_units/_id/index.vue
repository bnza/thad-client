<template>
  <v-card>
    <v-toolbar flat dense>
      ...
      <navigation-update-resource-button :item-id="routeRequestedId" resource-name="stratigraphic_units" :disabled="!$auth.hasScope('ROLE_EDITOR')" />
      <navigation-delete-resource-button :item-id="routeRequestedId" resource-name="stratigraphic_units" :disabled="!$auth.hasScope('ROLE_EDITOR')" />
      <template #extension>
